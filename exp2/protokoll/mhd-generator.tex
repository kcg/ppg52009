...
An den in Abbildung ??? zu erkennenden Löchern wurden Schlauchstutzen aus Kunststoff angebracht, um vorne und hinten den Durchlaufschlauch und seitlich dünnere Schläuche zur Druckmessung befestigen zu können.
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=0.8\textwidth]{images/zelle-einzeln.jpg}
\end{center}
\vspace{-1.5\baselineskip}
...
%%Ich will das Diagramm genau hier haben! Geht das? Notfalls kleiner?
...
Hierbei entspricht $g = 9,81 \unit{\frac{m}{s}}$ der Schwerebeschleunigung.\\
