...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=0.8\textwidth]{images/kennlinien1.pdf}
\end{center}
\vspace{-1.5\baselineskip}
...
Der spezifische Widerstand konnte bei dieser zweiten Vormessung auf einen Bereich von $1 \ee{2} \ \Omega \unit{m}$ abgeschätzt werden, bei einer Salzkonzentration von $0.15 \%$
...
Grafik \hyperref[messkurve_spannung]{Abb.~\ref{messkurve_spannung}} zeigt exemplarisch den Zellspannungsverlauf für $B=50\unit{mT}$. 

%% Rest dieses Absatzes morgen(heute) (7.12.); v.a. noch fehlend: Erklärung Spannungsverlauf, Grundspannung; vg Andi
