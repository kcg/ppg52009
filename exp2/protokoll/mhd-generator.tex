...
\hyperref[messkurve_spannung]{Abb.~\ref{messkurve_spannung}} zeigt exemplarisch den Zellspannungsverlauf für beim Auf-bzw Abbau des angelegten Magnetfeldes (Peak-Wert $B=50\unit{mT}$). Auch hier ist gut erkennbar, dass $U \propto B$ gilt. \
