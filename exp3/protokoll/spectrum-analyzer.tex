...
Um die Photoströme aller 16 LEDs auf einfache Weise gleichzeitug messen zu können, haben wir in der Elektronikwerkstatt zwei Platinen ätzen lassen (siehe \ref{fig:electronics}).

\begin{figure}[H]
\begin{center}
\includegraphics[width=1.\textwidth]{images/platinen.jpg}
\end{center}
\vspace{-1.5\baselineskip}
...
Um die Photoströme der LEDs (typ. $100 \unit{nA}$) in eine messbare Spannung umsetzen zu können verwenden wir uns ein Transimpedanzverstärker-Schaltungen (siehe \ref{fig:transimp}), welche im wesentlichen aus den die LEDs umgebenden Operationsverstärker bestehen.
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.3\textwidth]{images/transimpedanz.png}
\end{center}
\vspace{-1.5\baselineskip}
