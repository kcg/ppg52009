...
&=& (\omega\ltext{mess} + \omega\ltext{dreh}\cos\alpha) \cdot J\ltext{kurz}
\end{eqnarray}
\begin{equation}
\boxed{
\omega\ltext{Erde} =
...
\begin{equation}
\omega\ltext{Cassymessung} = 138,51 \unit{\frac{deg}{s}}
\end{equation}
...
\begin{equation}
\omega\ltext{Messung} = 33,35 \frac{\unit{deg}}{\unit{s}} = 0,582 \unit{s^{-1}}
\end{equation}
