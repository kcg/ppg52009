...
Allerdings hatten wir mit starken Schwingungs- und Reibungseffekten zu kämpfen, so unsere Werte am Ende immer noch um einen Faktor 10 ???? daneben lagen.
\end{abstract}
\newpage
...
Wäre es allerdings Galileo Galilei als Begründer der modernen Experimentalphysik gelungen, unseren Aufbau ein wenig präziser durchrzuführen, so hätte der den unumstößlichen Beweis in Händen gehabt:
