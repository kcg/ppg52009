...
R = R_I+R_{\text{L}}\;.
\]
Der zusätzliche Lastwiderstand $R_{\text{L}}$ wurde nun im Bereich 0 -- $40\unit{k\Omega}$ variiert und jeweils wenige Minuten gewartet bis sich stationäre Werte einstellten. Die Messwerte stehen in Tabelle \ref{leistungsmesstabelle}.
\begin{table}[ht]
